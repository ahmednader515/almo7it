...
export default function BalancePage() {
  ...
  const vodafoneCashNumber = "01015937170";
  const whatsappNumber = "01015937170";
  const whatsappLink = `https://wa.me/201015937170`;
      ...
      {isStudent && (
        <Card className="border-brand/20 bg-brand/5">
          <CardHeader>
            ...
            <CardDescription>
              الدفع متاح عبر فودافون كاش فقط. حوّل المبلغ إلى الرقم التالي من تطبيق فودافون كاش، ثم أرسل صورة الإيصال
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="bg-card rounded-lg p-4 border-2 border-brand/30">
              <div className="flex items-center justify-between">
                ...
                <Button
                  variant="outline"
                  size="icon"
                  onClick={() => copyToClipboard(vodafoneCashNumber, setCopiedWalletNumber)}
                  className="h-10 w-10"
                >
                  {copiedWalletNumber ? (
            ...
            <div className="bg-muted/50 rounded-lg p-4 space-y-2">
              <p className="font-semibold text-sm">طريقة الدفع: فودافون كاش فقط</p>
              <p className="font-semibold text-sm">خطوات الإيداع:</p>
              <ol className="list-decimal list-inside space-y-1 text-sm text-muted-foreground">
                <li>افتح تطبيق فودافون كاش وحوّل المبلغ المطلوب إلى الرقم أعلاه</li>
